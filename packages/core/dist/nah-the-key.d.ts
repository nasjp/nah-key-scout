...
import { DEFAULT_PRICING_CONFIG, HOUSE_TABLE, hydrateThumbnails, resolveOgImage } from "./nah-the-key.seed";
import type { Area, Capacity, HouseId, HouseInfo, PricingConfig } from "./nah-the-key.types";
...
export { HOUSE_TABLE, DEFAULT_PRICING_CONFIG, hydrateThumbnails, resolveOgImage, parseCheckinDateJst, };
...
export declare function computeActualPerNightJpy(priceEth: number, nights: number, cfg?: PricingConfig): number;
export declare function computeDiscountPct(actualPerNightJpy: number | undefined, fairPerNightJpy: number | undefined): number | undefined;
export declare function computeMaxBidEth(fairPerNightJpy: number | undefined, nights: number | undefined, targetDiscountRate: number, // 0.25 → 25%
cfg?: PricingConfig): number | undefined;
