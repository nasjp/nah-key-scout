...
export declare function buildListingsUrl(
  slug: string,
  mode: Mode,
  limit?: number,
  next?: string,
): string;
export declare function fetchAllListings(
  slug: string,
  apiKey: string,
  mode?: Mode,
): Promise<Listing[]>;
export declare function fetchNftMeta(
  contract: string,
  tokenId: string,
  apiKey: string,
): Promise<NftApiResponse>;
export declare function joinListingWithTraits(
  listing: Listing,
  meta: NftApiResponse | null,
): JoinedRow;
export declare function fetchOpenseaListingsJoined(
  slug: string,
  apiKey: string,
  mode?: Mode,
): Promise<JoinedRow[]>;
